...
import { lintingRules, lintingRulesPrettier } from './lib/ruleset/eslint.rules.js';
...
export const monostylePresetNxTs: ConfigArray = [...monostylePresetTs, ...nxRules];
...
export const monostylePresetNxTsPrettier: ConfigArray = [...monostylePresetTsPrettier, ...nxRules];
